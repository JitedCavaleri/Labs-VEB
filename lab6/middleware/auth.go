...
//   - user_id     (string) — для хендлеров (Лаба 6: hex от MongoDB ObjectID)
...
//
// Лаба 6: возвращает string (hex от ObjectID). Хендлеры/сервисы конвертируют его
// в primitive.ObjectID через primitive.ObjectIDFromHex при необходимости.

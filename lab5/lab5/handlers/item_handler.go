...
func (h *ItemHandler) GetByID(c *gin.Context) {
	...
	item, err := h.Service.GetByID(c.Request.Context(), userID, uint(id))
	if err != nil {
...
func (h *ItemHandler) Update(c *gin.Context) {
	...
	item, err := h.Service.Update(c.Request.Context(), userID, uint(id), req)
	if err != nil {
		handleItemError(c, err)
		return
	}
...
func (h *ItemHandler) Patch(c *gin.Context) {
	...
	item, err := h.Service.Patch(c.Request.Context(), userID, uint(id), req)
	if err != nil {
		handleItemError(c, err)
		return
	}
